...
for (file in list.files(out_path)){
  ...
  # HIST
  png(file = paste0("PEA/imgs/hist/",filename,".png"), width = 400, height = 300)
  ...
  pdf(file = paste("PEA/imgs/barplot/", filename, ".pdf", sep = ""), width = 20, height = 15)
  print(gg)
  dev.off()
  ...
  pdf(file = paste("PEA/imgs/enrichment/", filename, ".pdf", sep = ""), width = 8, height = 6)
  print(gg)
  dev.off()
